import { Container, Title, Text, Button, Stack, Group, Paper, ActionIcon } from '@mantine/core';
...
function Home() {
  ...
  return (
    <Container size="sm" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', position: 'relative' }}>
      <ActionIcon
        variant="filled"
        size="xl"
