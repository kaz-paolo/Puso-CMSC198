import { Group, Text, ActionIcon, useMantineTheme, useMantineColorScheme } from '@mantine/core';
...
function Header({ onThemeClick }) {
  ...
  return (
    ...
    >
      <Group>
        <Text size="xl" fw={700}>PULSO</Text>
      </Group>
      ...
      <Group gap="sm">
        ...
        <ActionIcon variant="subtle" size="lg" onClick={onThemeClick} color="brand">
          <IconPalette size={20} />
        </ActionIcon>
      </Group>
    </Group>
